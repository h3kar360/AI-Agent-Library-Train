...
response_model = init_chat_model(model="google_genai:gemini-3.5-flash-lite")
...
grader_model = init_chat_model("google_genai:gemini-3.5-flash-lite")
...
REWRITE_PROMPT = (
    ...
    "{question}"
    "\n ------- \n"
    "Formulate an improved question. Just give the new query and not suggestions:"
)
